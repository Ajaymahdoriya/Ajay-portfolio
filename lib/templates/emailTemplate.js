    ...
    <div class="footer">
        <table class="footer-table" cellpadding="0" cellspacing="0" width="100%" style="max-width:600px;margin:0 auto;">
            <tbody>
                <tr>
                    <td>
                        <img class="profile-img" src="https://media.licdn.com/dms/image/v2/D4D35AQE0N_B0n-zqMQ/profile-framedphoto-shrink_800_800/B4DZZalMcZHAAo-/0/1745276422264?e=1765738800&v=beta&t=aW8RIFDHMeKnN8LPQqhf9mP26v8KNMrUt0bWBmaFR-w" alt="Ajay M">
                    </td>
                    <td class="social-icons">
                        <a href="https://www.linkedin.com/in/bhuvanshivhare/" target="_blank">
                            <img class="icon" src="https://cdn-icons-png.flaticon.com/512/174/174857.png" alt="LinkedIn">
                        </a>
                        <a href="https://github.com/Ajaymahdoriya" target="_blank">
                            <img class="icon" src="https://cdn-icons-png.flaticon.com/512/25/25231.png" alt="GitHub">
                        </a>
                        <a href="https://x.com/bhuvan" target="_blank">
                            <img class="icon" src="https://cdn-icons-png.flaticon.com/512/733/733579.png" alt="Twitter">
                        </a>
                    </td>
                    <td>
                        <p style="margin:4px 0"><a href="mailto:ajay.mahdoriya7505@gmail.com">ajay.mahdoriya7505@gmail.com</a></p>
                        <p style="margin:4px 0"><a href="tel:+918319198379">+91 8319198379</a></p>
                        <p style="margin:4px 0">Bhopal, Madhya Pradesh</p>
                    </td>
                </tr>
            </tbody>
        </table>
        <p>&copy; 2024 bhuvanshivhare. All rights reserved.</p>
    </div>
</div>
</body>
</html>
